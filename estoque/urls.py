...
urlpatterns = [
    ...
    path("depositos/cadastrar/", views.cadastrar_deposito, name="cadastrar_deposito"),
    path('depositos/editar/<int:deposito_id>/', views.editar_deposito, name="editar_deposito"),
    path('depositos/excluir/<int:deposito_id>/', views.excluir_deposito, name="excluir_deposito"),
    ...
    path("relatorios/",  views.relatorio_produtos, name="relatorio_produtos"),
]